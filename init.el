...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(pangu-spacing wakatime-mode)
...
before packages are loaded."
  ...
  ;; org-agneda
  ;; define task status
  (setq org-todo-keywords '((sequence "TODO(t)" "WAITING(w)" "DOING(d)" "|" "DONE(n)" "CANCELLED(c)")))
  ...
  ;; org-capture
  ;;org-capture-tempaltes

  (setq org-capture-templates
        '(
          ("r" "reading" entry
           (file+olp "~/study/agenda/reading.org" "book")
           "** TODO [#B] %^{书名}\n SCHEDULED:%T")
          ("n" "notes" entry
           (file+olp "~/study/agenda/notes.org" "待整理的笔记")
           "** TODO [#B] %^{笔记标题}\n SCHEDULED:%T")
          ("i" "ideas" entry
           (file+olp "~/study/agenda/ideas.org" "ideas")
           "** WAITING [#C] %^{想法内容}\n SCHEDULED:%T")
          )
        )
  ...
  (use-package wakatime-mode
    :init
    (setq wakatime-api-key "22b8639c-12ff-416a-b75e-22aa18a0fd0e")
...
(custom-set-variables
 ...
 '(wakatime-python-bin "/Users/zing/Library/Python/2.7/bin/wakatime")
 '(weechat-color-list
